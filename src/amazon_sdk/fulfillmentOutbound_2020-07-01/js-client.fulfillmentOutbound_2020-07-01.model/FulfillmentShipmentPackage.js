...
export class FulfillmentShipmentPackage {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('amazonFulfillmentTrackingNumber'))
        obj.amazonFulfillmentTrackingNumber = ApiClient.convertToType(data['amazonFulfillmentTrackingNumber'], 'String');
