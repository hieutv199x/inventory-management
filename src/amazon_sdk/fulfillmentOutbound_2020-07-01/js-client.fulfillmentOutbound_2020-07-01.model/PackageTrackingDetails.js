  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('deliveryWindow'))
        obj.deliveryWindow = DateRange.constructFromObject(data['deliveryWindow']);
 ...
 * @member {module:fulfillmentOutbound_2020-07-01/js-client.fulfillmentOutbound_2020-07-01.model/DateRange} deliveryWindow
 */
