...
export class FbaInboundApi {
    ...
    */
     ...
     * @param {module:fulfillmentInbound_2024-03-20/js-client.fulfillmentInbound_2024-03-20.model/UpdateBoxIdentifiersRequest} body The body of the request to `updateBoxIdentifiers`.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:fulfillmentInbound_2024-03-20/js-client.fulfillmentInbound_2024-03-20.model/UpdateBoxIdentifiersResponse} and HTTP response
     */
    updateBoxIdentifiersWithHttpInfo(inboundPlanId, shipmentId, body) {
      ...
      let contentTypes = ['application/json'];
      let accepts = ['application/json'];
      let returnType = UpdateBoxIdentifiersResponse;
     ...
     * @param {String} shipmentId Identifier to a shipment. A shipment contains the boxes and units being inbounded.
     * @param {module:fulfillmentInbound_2024-03-20/js-client.fulfillmentInbound_2024-03-20.model/UpdateBoxIdentifiersRequest} body The body of the request to `updateBoxIdentifiers`.
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:fulfillmentInbound_2024-03-20/js-client.fulfillmentInbound_2024-03-20.model/UpdateBoxIdentifiersResponse}
     */
