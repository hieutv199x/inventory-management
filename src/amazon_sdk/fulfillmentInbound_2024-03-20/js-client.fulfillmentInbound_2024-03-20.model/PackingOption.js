...
export class PackingOption {
   ...
   * @param supportedConfigurations {Array.<module:fulfillmentInbound_2024-03-20/js-client.fulfillmentInbound_2024-03-20.model/PackingConfiguration>} A list of possible configurations for this option.
   * @param supportedShippingConfigurations {Array.<module:fulfillmentInbound_2024-03-20/js-client.fulfillmentInbound_2024-03-20.model/ShippingConfiguration>} **This field is deprecated**. Use the `shippingRequirements` property under `supportedConfigurations` instead. List of supported shipping modes.
   */
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('supportedConfigurations'))
        obj.supportedConfigurations = ApiClient.convertToType(data['supportedConfigurations'], [PackingConfiguration]);
 ...
 * @member {Array.<module:fulfillmentInbound_2024-03-20/js-client.fulfillmentInbound_2024-03-20.model/PackingConfiguration>} supportedConfigurations
 */
