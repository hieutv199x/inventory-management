 ...
 * @module transfers_2024-06-01/js-client.transfers_2024-06-01.model/InitiatePayoutResponse
 * @version 2024-06-01
 */
export class InitiatePayoutResponse {
   ...
   * @alias module:transfers_2024-06-01/js-client.transfers_2024-06-01.model/InitiatePayoutResponse
   * @class
   ...
   * @param {module:transfers_2024-06-01/js-client.transfers_2024-06-01.model/InitiatePayoutResponse} obj Optional instance to populate.
   * @return {module:transfers_2024-06-01/js-client.transfers_2024-06-01.model/InitiatePayoutResponse} The populated <code>InitiatePayoutResponse</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('payoutReferenceId'))
        obj.payoutReferenceId = ApiClient.convertToType(data['payoutReferenceId'], 'String');
    }
    return obj;
  }
}
