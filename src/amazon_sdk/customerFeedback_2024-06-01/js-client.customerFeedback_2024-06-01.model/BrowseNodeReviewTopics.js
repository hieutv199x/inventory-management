 ...
 * @module customerFeedback_2024-06-01/js-client.customerFeedback_2024-06-01.model/BrowseNodeReviewTopics
 * @version 2024-06-01
 */
export class BrowseNodeReviewTopics {
   ...
   * @alias module:customerFeedback_2024-06-01/js-client.customerFeedback_2024-06-01.model/BrowseNodeReviewTopics
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:customerFeedback_2024-06-01/js-client.customerFeedback_2024-06-01.model/BrowseNodeReviewTopics} obj Optional instance to populate.
   * @return {module:customerFeedback_2024-06-01/js-client.customerFeedback_2024-06-01.model/BrowseNodeReviewTopics} The populated <code>BrowseNodeReviewTopics</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('positiveTopics'))
        obj.positiveTopics = ApiClient.convertToType(data['positiveTopics'], [BrowseNodeReviewTopic]);
      if (data.hasOwnProperty('negativeTopics'))
        obj.negativeTopics = ApiClient.convertToType(data['negativeTopics'], [BrowseNodeReviewTopic]);
    }
    return obj;
  }
}
 ...
 * @member {Array.<module:customerFeedback_2024-06-01/js-client.customerFeedback_2024-06-01.model/BrowseNodeReviewTopic>} positiveTopics
 */
 ...
 * @member {Array.<module:customerFeedback_2024-06-01/js-client.customerFeedback_2024-06-01.model/BrowseNodeReviewTopic>} negativeTopics
 */
