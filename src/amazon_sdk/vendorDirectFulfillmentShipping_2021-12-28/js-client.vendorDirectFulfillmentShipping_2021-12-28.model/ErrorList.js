...
export class ErrorList {
   ...
   * @class
   * @param errors {Array.<module:vendorDirectFulfillmentShipping_2021-12-28/js-client.vendorDirectFulfillmentShipping_2021-12-28.model/Error>} An array of Error objects representing individual errors encountered during the request.
   */
  constructor(errors) {
    this.errors = errors;
  }
