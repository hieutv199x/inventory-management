 ...
 * @module services/js-client.services.model/DateTimeRange
 * @version v1
 */
export class DateTimeRange {
   ...
   * A range of time.
   * @alias module:services/js-client.services.model/DateTimeRange
   * @class
   ...
   * @param {module:services/js-client.services.model/DateTimeRange} obj Optional instance to populate.
   * @return {module:services/js-client.services.model/DateTimeRange} The populated <code>DateTimeRange</code> instance.
   */
