...
export class InventoryUpdate {
   ...
   * @class
   * @param sellingParty {module:vendorDirectFulfillmentInventoryV1/js-client.vendorDirectFulfillmentInventoryV1.model/PartyIdentification} ID of the selling party or vendor.
