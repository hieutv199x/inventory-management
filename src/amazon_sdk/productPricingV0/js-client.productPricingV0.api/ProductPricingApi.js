...
export class ProductPricingApi {
    ...
    */
     ...
     * @param {module:productPricingV0/js-client.productPricingV0.model/GetItemOffersBatchRequest} getItemOffersBatchRequestBody The request associated with the `getItemOffersBatch` API call.
     ...
     * @param {module:productPricingV0/js-client.productPricingV0.model/GetListingOffersBatchRequest} getListingOffersBatchRequestBody The request associated with the `getListingOffersBatch` API call.
