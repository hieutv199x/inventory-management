 ...
 * @module messaging/js-client.messaging.model/CreateDigitalAccessKeyRequest
 * @version v1
 */
export class CreateDigitalAccessKeyRequest {
   ...
   * @alias module:messaging/js-client.messaging.model/CreateDigitalAccessKeyRequest
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:messaging/js-client.messaging.model/CreateDigitalAccessKeyRequest} obj Optional instance to populate.
   * @return {module:messaging/js-client.messaging.model/CreateDigitalAccessKeyRequest} The populated <code>CreateDigitalAccessKeyRequest</code> instance.
   */
