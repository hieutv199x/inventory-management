...
export class SalesApi {
    ...
    */
     ...
     * @param {module:sales/js-client.sales.model/String} opts.amazonProgram Filters the results by the Amazon program that you specify. Do not include this filter if you want the response to include order metrics for all programs. **Example:** `AmazonHaul` returns order metrics for the Amazon Haul program only.
