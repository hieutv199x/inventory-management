 ...
 * @module vendorOrders/js-client.vendorOrders.model/Pagination
 * @version v1
 */
export class Pagination {
   ...
   * @alias module:vendorOrders/js-client.vendorOrders.model/Pagination
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:vendorOrders/js-client.vendorOrders.model/Pagination} obj Optional instance to populate.
   * @return {module:vendorOrders/js-client.vendorOrders.model/Pagination} The populated <code>Pagination</code> instance.
   */
