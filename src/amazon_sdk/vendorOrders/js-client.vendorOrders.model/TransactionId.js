 ...
 * @module vendorOrders/js-client.vendorOrders.model/TransactionId
 * @version v1
 */
export class TransactionId {
   ...
   * @alias module:vendorOrders/js-client.vendorOrders.model/TransactionId
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:vendorOrders/js-client.vendorOrders.model/TransactionId} obj Optional instance to populate.
   * @return {module:vendorOrders/js-client.vendorOrders.model/TransactionId} The populated <code>TransactionId</code> instance.
   */
