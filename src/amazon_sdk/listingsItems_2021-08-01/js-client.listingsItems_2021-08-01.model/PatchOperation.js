...
export class PatchOperation {
   ...
   * @class
   * @param op {module:listingsItems_2021-08-01/js-client.listingsItems_2021-08-01.model/PatchOperation.OpEnum} Type of JSON Patch operation. Supported JSON Patch operations include `add`, `replace`, `merge` and `delete`. Refer to <https://tools.ietf.org/html/rfc6902>.
