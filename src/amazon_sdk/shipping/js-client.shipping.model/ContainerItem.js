...
export class ContainerItem {
   ...
   * @param unitPrice {module:shipping/js-client.shipping.model/Currency} The unit price of an item of this type (the total value of this item type in the container is unitPrice x quantity).
   * @param unitWeight {module:shipping/js-client.shipping.model/Weight} The unit weight of an item of this type (the total weight of this item type in the container is unitWeight x quantity).
