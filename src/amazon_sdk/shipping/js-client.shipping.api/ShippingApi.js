...
export class ShippingApi {
    ...
    */
     ...
     * @param {module:shipping/js-client.shipping.model/CreateShipmentRequest} body CreateShipmentRequest Body
     ...
     * @param {module:shipping/js-client.shipping.model/GetRatesRequest} body GetRatesRequest body
     ...
     * @param {module:shipping/js-client.shipping.model/PurchaseLabelsRequest} body PurchaseShippingLabelRequest body
     ...
     * @param {module:shipping/js-client.shipping.model/PurchaseShipmentRequest} body PurchaseShipmentRequest body
     ...
     * @param {String} trackingId Tracking Id
     * @param {module:shipping/js-client.shipping.model/RetrieveShippingLabelRequest} body RetrieveShippingLabelRequest body
