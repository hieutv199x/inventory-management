 ...
 * @module productFeesV0/js-client.productFeesV0.model/MoneyType
 * @version v0
 */
export class MoneyType {
   ...
   * @alias module:productFeesV0/js-client.productFeesV0.model/MoneyType
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:productFeesV0/js-client.productFeesV0.model/MoneyType} obj Optional instance to populate.
   * @return {module:productFeesV0/js-client.productFeesV0.model/MoneyType} The populated <code>MoneyType</code> instance.
   */
