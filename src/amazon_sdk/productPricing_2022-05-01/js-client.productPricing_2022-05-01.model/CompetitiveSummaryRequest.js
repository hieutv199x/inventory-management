...
export class CompetitiveSummaryRequest {
   ...
   * @class
   * @param asin {module:productPricing_2022-05-01/js-client.productPricing_2022-05-01.model/Asin} The Amazon Standard Identification Number for the item.
   ...
   * @param uri {module:productPricing_2022-05-01/js-client.productPricing_2022-05-01.model/HttpUri} The URI associated with the individual APIs that are called as part of the batch request. For `getCompetitiveSummary`, this is `/products/pricing/2022-05-01/items/competitiveSummary`.
   */
