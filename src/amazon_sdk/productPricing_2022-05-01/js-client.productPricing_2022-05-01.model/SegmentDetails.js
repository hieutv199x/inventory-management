  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('sampleLocation'))
        obj.sampleLocation = SampleLocation.constructFromObject(data['sampleLocation']);
    }
    return obj;
  }
}
 ...
 * @member {module:productPricing_2022-05-01/js-client.productPricing_2022-05-01.model/SampleLocation} sampleLocation
 */
