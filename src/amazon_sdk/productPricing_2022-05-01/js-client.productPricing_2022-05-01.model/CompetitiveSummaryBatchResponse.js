...
export class CompetitiveSummaryBatchResponse {
   ...
   * @class
   * @param responses {module:productPricing_2022-05-01/js-client.productPricing_2022-05-01.model/CompetitiveSummaryResponseList} The response list for the `competitiveSummaryBatch` operation.
   */
