 ...
 * @module vendorDirectFulfillmentOrdersV1/js-client.vendorDirectFulfillmentOrdersV1.model/OrderItemAcknowledgement
 * @version v1
 */
export class OrderItemAcknowledgement {
   ...
   * @alias module:vendorDirectFulfillmentOrdersV1/js-client.vendorDirectFulfillmentOrdersV1.model/OrderItemAcknowledgement
   * @class
   * @param itemSequenceNumber {String} Line item sequence number for the item.
   * @param acknowledgedQuantity {module:vendorDirectFulfillmentOrdersV1/js-client.vendorDirectFulfillmentOrdersV1.model/ItemQuantity} Details of quantity acknowledged with the above acknowledgement code.
   */
   ...
   * @param {module:vendorDirectFulfillmentOrdersV1/js-client.vendorDirectFulfillmentOrdersV1.model/OrderItemAcknowledgement} obj Optional instance to populate.
   * @return {module:vendorDirectFulfillmentOrdersV1/js-client.vendorDirectFulfillmentOrdersV1.model/OrderItemAcknowledgement} The populated <code>OrderItemAcknowledgement</code> instance.
   */
 ...
 * @member {module:vendorDirectFulfillmentOrdersV1/js-client.vendorDirectFulfillmentOrdersV1.model/ItemQuantity} acknowledgedQuantity
 */
