...
export class VendorOrdersApi {
    ...
    */
     ...
     * @param {module:vendorDirectFulfillmentOrdersV1/js-client.vendorDirectFulfillmentOrdersV1.model/SubmitAcknowledgementRequest} body The request body containing the acknowledgement to an order.
