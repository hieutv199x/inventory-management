  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('carrierAccounts'))
        obj.carrierAccounts = CarrierAccounts.constructFromObject(data['carrierAccounts']);
    }
    return obj;
  }
}
...
/**
 * @member {module:shippingV2/js-client.shippingV2.model/CarrierAccounts} carrierAccounts
 */
