 ...
 * @module shippingV2/js-client.shippingV2.model/AccessPointDetails
 * @version v2
 */
export class AccessPointDetails {
   ...
   * @alias module:shippingV2/js-client.shippingV2.model/AccessPointDetails
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:shippingV2/js-client.shippingV2.model/AccessPointDetails} obj Optional instance to populate.
   * @return {module:shippingV2/js-client.shippingV2.model/AccessPointDetails} The populated <code>AccessPointDetails</code> instance.
   */
