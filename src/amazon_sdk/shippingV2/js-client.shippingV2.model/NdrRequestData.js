...
import {AdditionalAddressNotes} from './AdditionalAddressNotes.js';

/**
 * The NdrRequestData model module.
 * @module shippingV2/js-client.shippingV2.model/NdrRequestData
 * @version v2
 */
export class NdrRequestData {
   ...
   * @alias module:shippingV2/js-client.shippingV2.model/NdrRequestData
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:shippingV2/js-client.shippingV2.model/NdrRequestData} obj Optional instance to populate.
   * @return {module:shippingV2/js-client.shippingV2.model/NdrRequestData} The populated <code>NdrRequestData</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('additionalAddressNotes'))
        obj.additionalAddressNotes = AdditionalAddressNotes.constructFromObject(data['additionalAddressNotes']);
    }
    return obj;
  }
}
...
/**
 * @member {module:shippingV2/js-client.shippingV2.model/AdditionalAddressNotes} additionalAddressNotes
 */
