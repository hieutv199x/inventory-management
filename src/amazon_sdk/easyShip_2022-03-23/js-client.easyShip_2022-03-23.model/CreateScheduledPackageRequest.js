 ...
 * @module easyShip_2022-03-23/js-client.easyShip_2022-03-23.model/CreateScheduledPackageRequest
 * @version 2022-03-23
 */
export class CreateScheduledPackageRequest {
   ...
   * @alias module:easyShip_2022-03-23/js-client.easyShip_2022-03-23.model/CreateScheduledPackageRequest
   * @class
   ...
   * @param packageDetails {module:easyShip_2022-03-23/js-client.easyShip_2022-03-23.model/PackageDetails} 
   */
   ...
   * @param {module:easyShip_2022-03-23/js-client.easyShip_2022-03-23.model/CreateScheduledPackageRequest} obj Optional instance to populate.
   * @return {module:easyShip_2022-03-23/js-client.easyShip_2022-03-23.model/CreateScheduledPackageRequest} The populated <code>CreateScheduledPackageRequest</code> instance.
   */
