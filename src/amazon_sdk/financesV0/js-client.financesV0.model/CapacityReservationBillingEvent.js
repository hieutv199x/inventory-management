 ...
 * @module financesV0/js-client.financesV0.model/CapacityReservationBillingEvent
 * @version v0
 */
export class CapacityReservationBillingEvent {
   ...
   * @alias module:financesV0/js-client.financesV0.model/CapacityReservationBillingEvent
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:financesV0/js-client.financesV0.model/CapacityReservationBillingEvent} obj Optional instance to populate.
   * @return {module:financesV0/js-client.financesV0.model/CapacityReservationBillingEvent} The populated <code>CapacityReservationBillingEvent</code> instance.
   */
