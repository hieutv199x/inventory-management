 ...
 * @readonly
 */
const DeliveryExperienceOption = {
  /**
   ...
   * @return {module:merchantFulfillmentV0/js-client.merchantFulfillmentV0.model/DeliveryExperienceOption} The enum <code>DeliveryExperienceOption</code> value.
   */
...
export {DeliveryExperienceOption};
