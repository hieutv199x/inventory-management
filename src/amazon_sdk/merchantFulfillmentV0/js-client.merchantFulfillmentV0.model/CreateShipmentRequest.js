...
export class CreateShipmentRequest {
   ...
   * @class
   * @param shipmentRequestDetails {module:merchantFulfillmentV0/js-client.merchantFulfillmentV0.model/ShipmentRequestDetails} Shipment information required to create a shipment.
