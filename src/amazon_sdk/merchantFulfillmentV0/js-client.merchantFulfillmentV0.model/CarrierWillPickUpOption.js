...
const CarrierWillPickUpOption = {
   ...
   * @return {module:merchantFulfillmentV0/js-client.merchantFulfillmentV0.model/CarrierWillPickUpOption} The enum <code>CarrierWillPickUpOption</code> value.
   */
...
export {CarrierWillPickUpOption};
