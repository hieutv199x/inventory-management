...
export class MerchantFulfillmentApi {
    ...
    */
     ...
     * @param {module:merchantFulfillmentV0/js-client.merchantFulfillmentV0.model/CreateShipmentRequest} body The request schema for the `CreateShipment` operation.
     ...
     * @param {module:merchantFulfillmentV0/js-client.merchantFulfillmentV0.model/GetAdditionalSellerInputsRequest} body The request schema for the `GetAdditionalSellerInputs` operation.
     ...
     * @param {module:merchantFulfillmentV0/js-client.merchantFulfillmentV0.model/GetEligibleShipmentServicesRequest} body The request schema for the `GetEligibleShipmentServices` operation.
