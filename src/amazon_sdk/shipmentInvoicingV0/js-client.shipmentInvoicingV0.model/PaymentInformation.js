 ...
 * @module shipmentInvoicingV0/js-client.shipmentInvoicingV0.model/PaymentInformation
 * @version v0
 */
export class PaymentInformation {
   ...
   * @alias module:shipmentInvoicingV0/js-client.shipmentInvoicingV0.model/PaymentInformation
   * @class
   */
  constructor() {
  }
   ...
   * @param {module:shipmentInvoicingV0/js-client.shipmentInvoicingV0.model/PaymentInformation} obj Optional instance to populate.
   * @return {module:shipmentInvoicingV0/js-client.shipmentInvoicingV0.model/PaymentInformation} The populated <code>PaymentInformation</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('PaymentMethod'))
        obj.paymentMethod = PaymentMethodEnum.constructFromObject(data['PaymentMethod']);
      ...
      if (data.hasOwnProperty('PaymentValue'))
        obj.paymentValue = Money.constructFromObject(data['PaymentValue']);
...
/**
 * Payment method name
 * @member {module:shipmentInvoicingV0/js-client.shipmentInvoicingV0.model/PaymentMethodEnum} paymentMethod
 */
 ...
 * @member {module:shipmentInvoicingV0/js-client.shipmentInvoicingV0.model/Money} paymentValue
 */
