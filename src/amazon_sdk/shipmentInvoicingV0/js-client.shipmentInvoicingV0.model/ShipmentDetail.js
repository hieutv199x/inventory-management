  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('Payments'))
        obj.payments = PaymentInformationList.constructFromObject(data['Payments']);
...
/**
 * @member {module:shipmentInvoicingV0/js-client.shipmentInvoicingV0.model/PaymentInformationList} payments
 */
