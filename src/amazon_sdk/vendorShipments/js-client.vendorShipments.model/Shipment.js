...
export class Shipment {
   ...
   * @param transactionType {module:vendorShipments/js-client.vendorShipments.model/Shipment.TransactionTypeEnum} Indicates the type of transportation request (for example, `New` or `Cancel`). Each `transactionType` has a unique set of operations and there are corresponding details to be populated for each operation.
