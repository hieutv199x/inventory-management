...
const translations: Record<Language, TranslationMap> = {
  en: {
      ...
      'orders.items_label': '{count} item(s)',
      'orders.track_label': 'Track: {tracking} - {provider}',
      // Fraud Alert
      'fraud.title': 'Fraud Alert',
      'fraud.subtitle': 'Monitor bank account mismatches and security alerts',
      ...
      'fraud.filters.shop_placeholder': 'All Shops',
      'fraud.filters.alert_type': 'Alert Type',
      'fraud.filters.alert_type.all': 'All Types',
      'fraud.filters.alert_type.mismatch': 'Bank Mismatches',
      ...
      'fraud.table.order_bank_account': 'Bank Accounts',
      'fraud.table.configured_bank_account': 'Configured Bank',
      'fraud.table.bank_created_date': 'Bank Created Date',
      'fraud.table.shop': 'Shop',
      'fraud.loading': 'Loading alerts...',
      'fraud.error': 'Error: {message}',
      'fraud.no_results': 'No fraud alerts found with the selected filters.',
      'fraud.status.mismatch': 'Mismatch',
  ...
  vi: {
      ...
      'orders.items_label': '{count} sản phẩm',
      'orders.track_label': 'Track: {tracking} - {provider}',
      // Fraud Alert
      'fraud.title': 'Cảnh báo gian lận',
      'fraud.subtitle': 'Theo dõi cảnh báo sai lệch tài khoản ngân hàng',
      'fraud.refresh': 'Làm mới',
      'fraud.total_alerts': 'Tổng cảnh báo',
      'fraud.bank_mismatches': 'Không khớp Bank',
      'fraud.no_bank_assigned': 'Chưa gắn Bank',
      'fraud.filters.shop_placeholder': 'Tất cả Shop',
      'fraud.filters.alert_type': 'Loại cảnh báo',
      'fraud.filters.alert_type.all': 'Tất cả',
      'fraud.filters.alert_type.mismatch': 'Không khớp Bank',
      'fraud.filters.alert_type.no_bank': 'Chưa gắn Bank',
      'fraud.filters.start_date': 'Từ ngày',
      'fraud.filters.end_date': 'Đến ngày',
      'fraud.table.no': 'STT',
      ...
      'fraud.table.payment_id': 'Payment ID',
      'fraud.table.paid_date': 'Ngày paid',
      'fraud.table.order_bank_account': 'Bank Accounts',
      'fraud.table.configured_bank_account': 'Bank get',
      'fraud.table.bank_created_date': 'Ngày get bank',
      'fraud.table.shop': 'Shop',
      'fraud.loading': 'Đang tải cảnh báo...',
      'fraud.error': 'Lỗi: {message}',
      'fraud.no_results': 'Không có cảnh báo với bộ lọc hiện tại.',
      'fraud.status.mismatch': 'Không khớp',
      'fraud.status.no_bank_assigned': 'Chưa gắn Bank',
