...
const translations: Record<Language, TranslationMap> = {
    en: {
        ...
        'fulfillmentTracking.table.sync': 'Sync',
        'fulfillmentTracking.sync.disabledCompleted': 'Sync disabled for completed tracking states.',
        'fulfillmentTracking.alert.processingWarning': 'Warning: {count} shipments have stayed in PROCESSING for 8+ days.',
        'fulfillmentTracking.alert.processingCritical': 'Critical: {count} shipments have stayed in PROCESSING for 10+ days.',
        'fulfillmentTracking.kanban.title': 'Processing Risk Board',
        'fulfillmentTracking.kanban.warning.title': 'Processing Warning',
        'fulfillmentTracking.kanban.warning.description': 'Shipments in PROCESSING for 8-9 days awaiting carrier pickup.',
        'fulfillmentTracking.kanban.critical.title': 'Processing Critical',
        'fulfillmentTracking.kanban.critical.description': 'Shipments in PROCESSING for 10+ days requiring escalation.',
        'fulfillmentTracking.toast.syncSuccess': 'Tracking sync triggered.',
        'fulfillmentTracking.toast.syncError': 'Failed to trigger tracking sync.',
        'fulfillmentTracking.status.processing': 'PROCESSING - Package has been arranged by seller. Waiting for carrier to collect the parcel.',
        'fulfillmentTracking.status.fulfilling': 'FULFILLING - Package has been collected by carrier and in transit.',
        'fulfillmentTracking.status.completed': 'COMPLETED - Package has been delivered.',
        'fulfillmentTracking.status.cancelled': 'CANCELLED - Package has been canceled (often lost or damaged).',
        ...
        'permissions.assign_modal.no_shops_available': 'No shops available to assign.',
        'permissions.assign_modal.success_single': 'User assigned to shop successfully.',
        'permissions.assign_modal.success_multiple': 'User assigned to {count} shops successfully.',
        'permissions.assign_modal.generic_error': 'Failed to assign user to some shops. Please try again.',
        'permissions.assign_modal.shop_helper': 'Choose one or more shops to grant access. {count, number} shop(s) match your filter.',
        'permissions.assign_modal.select_all': 'Select all',
        'permissions.assign_modal.clear_all': 'Clear all',
        'permissions.assign_modal.shop_code': 'Code: {code}',
        'permissions.assign_modal.shop_group': 'Group: {group}',
        'permissions.assign_modal.filter_placeholder': 'Filter shops by name, code, or group…',
        'permissions.assign_modal.pagination_summary': 'Page {page} of {totalPages}',
        'permissions.assign_modal.prev_page': 'Previous',
        'permissions.assign_modal.next_page': 'Next',
        'permissions.assign_modal.page_indicator': 'Page {page} / {total}',
        ...
        'permissions.role.shop_connector.label': 'Shop Connector - Shop Connector',
        'permissions.role.shop_connector.desc': 'Can only connect TikTok shops to the system',
    ...
    vi: {
        ...
        'fulfillmentTracking.table.timeline': 'Timeline',
        'fulfillmentTracking.table.sync': 'Đồng bộ',
        'fulfillmentTracking.sync.disabledCompleted': 'Không thể đồng bộ khi trạng thái đã hoàn tất.',
        'fulfillmentTracking.alert.processingWarning': 'Cảnh báo: {count} vận đơn ở trạng thái PROCESSING trên 8 ngày.',
        'fulfillmentTracking.alert.processingCritical': 'Nguy cấp: {count} vận đơn ở trạng thái PROCESSING trên 10 ngày.',
        'fulfillmentTracking.kanban.title': 'Kanban cảnh báo trạng thái',
        'fulfillmentTracking.kanban.warning.title': 'Cảnh báo PROCESSING',
        'fulfillmentTracking.kanban.warning.description': 'Vận đơn PROCESSING từ 8-9 ngày, chờ đơn vị vận chuyển.',
        'fulfillmentTracking.kanban.critical.title': 'Nguy cấp PROCESSING',
        'fulfillmentTracking.kanban.critical.description': 'Vận đơn PROCESSING trên 10 ngày cần xử lý gấp.',
        'fulfillmentTracking.toast.syncSuccess': 'Đã kích hoạt đồng bộ tracking.',
        'fulfillmentTracking.toast.syncError': 'Kích hoạt đồng bộ tracking thất bại.',
        'fulfillmentTracking.status.processing': 'PROCESSING - Người bán đã sắp xếp lấy hàng, chờ hãng vận chuyển nhận bưu kiện.',
        'fulfillmentTracking.status.fulfilling': 'FULFILLING - Hãng vận chuyển đã nhận bưu kiện và đang giao.',
        'fulfillmentTracking.status.completed': 'COMPLETED - Bưu kiện đã được giao.',
        'fulfillmentTracking.status.cancelled': 'CANCELLED - Bưu kiện bị hủy (thường do thất lạc hoặc hư hỏng).',
        ...
        'permissions.assign_modal.no_shops_available': 'Không có cửa hàng nào khả dụng để phân quyền.',
        ...
        'permissions.assign_modal.shop_group': 'Nhóm: {group}',
        'permissions.assign_modal.filter_placeholder': 'Lọc cửa hàng theo tên, mã hoặc nhóm…',
        'permissions.assign_modal.pagination_summary': 'Trang {page} / {totalPages}',
        'permissions.assign_modal.prev_page': 'Trước',
        'permissions.assign_modal.next_page': 'Sau',
        'permissions.assign_modal.page_indicator': 'Trang {page} / {total}',
        ...
        'permissions.role.shop_connector.label': 'Shop Connector - Người kết nối cửa hàng',
        'permissions.role.shop_connector.desc': 'Chỉ có quyền kết nối cửa hàng TikTok',
